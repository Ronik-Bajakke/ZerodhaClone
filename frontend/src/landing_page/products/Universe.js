  ...
  return (
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/sensibullLogo.svg"style={{width:"65%",marginTop:"15px"}} />
          <p className="text-small text-muted mt-4">Options trading platform that lets you create strategies, analyze positions, and examine data points like open interest, FII/DII, and more.
</p>
        </div>
        <div className="col-4 p-3 mt-5">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/goldenpiLogo.png" style={{width:"58%"}}/>
